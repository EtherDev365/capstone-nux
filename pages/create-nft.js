...
const CreateNFT = () => {
  ...
  const fileStyle = useMemo(() => (
    `dark:bg-nft-black-1 bg-white border dark:border-white border-nft-gray-2 flex flex-col items-center p-5 rounded-sm border-dotted
  ...
  return (
    <div className="flex justify-center sm:px-4 p-12">
      <div className="w-3/5 md:w-full">
        <h1 className="font-poppins dark:text-white text-nft-black-1 text-2xl minlg:text-4xl font-semibold ml-4 sx:ml-0">Create new NFT
        </h1>
        <div className="mt-16">
          ...
          <div className="mt-4">
            <div {...getRootProps()} className={fileStyle}>
              ...
              <div className="flexCenter flex-col text-center">
                ...
                <p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-sm mt-2">or Browse file</p>
              </div>
            </div>
            {fileUrl && (
              <aside>
